			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="period.php"><i class="zmdi zmdi-timer zmdi-hc-fw"></i> Ver Turnos</a>
						</li>
						<li>
							<a href="file:///C:/Users/Propietario/Desktop/proye%20new/catalogo.html#"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Editar catalogo</a>
						</li>
						<li>
							<a href="period.php"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Ver consultas</a>
						</li>
						<li>
							<a href="period.php"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Ver pedidos</a>
						</li>
					</ul>
				</li>
				<li>
					<a class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-account-add zmdi-hc-fw"></i> Usuarios Registrados <i class="zmdi zmdi-caret-down pull-right"></i>
					</a>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Usuario <small>Admin</small></h1>
