...
<head>
    ...
    <link rel="stylesheet" href="css/turnos.css?v=<?php echo time(); ?>">
...
<div class="container-menu">
	...
	<h3 style='color: white; display:flex; justify-content:center'>Mi perfil</h3>
      ...
      <form class="post" method="post">
		...
		<input class="controls" type="datetime-local" name="fecha" id="fecha" min="<?php echo date('Y-m-d\TH:i', strtotime('+48 hours')); ?>"/>
